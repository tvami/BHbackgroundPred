...
#endif
void limits_combine_137p6fb_signals_C1_n4_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 09:57:49 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.005922318, 0.001134453, 0.0003491974, 9.693146e-05, 4.042969e-05, 2.665527e-05, 2.119922e-05, 1.835437e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01019438, 0.002576822, 0.0007666199, 0.0002805778, 0.0001228967, 8.105119e-05, 6.446355e-05, 5.581282e-05, 5.581282e-05, 5.377258e-06, 5.377258e-06, 6.210709e-06, 7.809162e-06, 1.200256e-05, 2.915516e-05, 0.0001118523, 0.0003545165,
   0.003238767 };
   ...
   Graph_Graph12->SetMinimum(4.839532e-06);
   Graph_Graph12->SetMaximum(0.01121328);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.007905273, 0.001876057, 0.0005579847, 0.0001776834, 7.781752e-05, 5.151756e-05, 4.114145e-05, 3.554729e-05, 3.554729e-05, 9.533991e-06, 9.533991e-06, 1.101172e-05, 1.384581e-05, 2.110813e-05, 5.086476e-05, 0.0001897311, 0.0005982466,
   0.00432896 };
   ...
   Graph_Graph23->SetMinimum(8.580592e-06);
   Graph_Graph23->SetMaximum(0.008694847);
   ...
   Double_t Graph0_fy4[8] = { 0.005922318, 0.001134453, 0.0003491974, 9.693146e-05, 4.042969e-05, 2.665527e-05, 2.119922e-05, 1.835437e-05 };
   ...
   Double_t Graph_fy5[8] = { 20.7, 4.31, 0.796, 0.121, 0.0138, 0.00103, 4.02e-05, 5.85e-07 };
   ...
   Double_t Graph_fy6[8] = { 18.63, 3.879, 0.7164, 0.1089, 0.01242, 0.000927, 3.618e-05, 5.265e-07 };
   ...
   Graph_Graph6->SetMinimum(4.7385e-07);
   Graph_Graph6->SetMaximum(20.493);
   ...
   Double_t Graph_fy7[8] = { 22.77, 4.741, 0.8756, 0.1331, 0.01518, 0.001133, 4.422e-05, 6.435e-07 };
   ...
   Graph_Graph7->SetMinimum(5.7915e-07);
   Graph_Graph7->SetMaximum(25.047);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.15661,0,10.15661,2.072617e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.15161,0,"  10.16 TeV");
