...
//=========  (Tue Jan  7 14:37:17 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(9.911334e-06);
   Graph_Graph12->SetMaximum(0.02281154);
   ...
   Graph_Graph23->SetMinimum(1.450612e-05);
   Graph_Graph23->SetMaximum(0.0193069);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.167,0,10.167,2.809815e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.162,0,"  10.17 TeV");
