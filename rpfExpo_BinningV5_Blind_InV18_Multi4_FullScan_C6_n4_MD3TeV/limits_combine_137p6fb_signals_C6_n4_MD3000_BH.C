...
#endif
void limits_combine_137p6fb_signals_C6_n4_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 23:21:16 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.004821014, 0.001329231, 0.0003396759, 0.0001038757, 4.082336e-05, 2.443359e-05, 1.89525e-05, 1.63736e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01458193, 0.003583523, 0.0008335127, 0.000286554, 0.0001241148, 7.429815e-05, 5.763162e-05, 4.978959e-05, 4.978959e-05, 4.860913e-06, 4.860913e-06, 5.55249e-06, 7.253723e-06, 1.243837e-05, 3.489575e-05, 0.0001247247, 0.0004776925,
   0.001732552 };
   ...
   Graph_Graph12->SetMinimum(4.374821e-06);
   Graph_Graph12->SetMaximum(0.01603964);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.009663641, 0.00253726, 0.0005928669, 0.000184202, 7.694802e-05, 4.673667e-05, 3.640351e-05, 3.171108e-05, 3.171108e-05, 8.54857e-06, 8.54857e-06, 9.844681e-06, 1.275665e-05, 2.17522e-05, 5.806872e-05, 0.0001969349, 0.0007304931,
   0.002649439 };
   ...
   Graph_Graph23->SetMinimum(7.693713e-06);
   Graph_Graph23->SetMaximum(0.01062915);
   ...
   Double_t Graph0_fy4[8] = { 0.004821014, 0.001329231, 0.0003396759, 0.0001038757, 4.082336e-05, 2.443359e-05, 1.89525e-05, 1.63736e-05 };
   ...
   Double_t Graph_fy5[8] = { 17.8, 3.03, 0.452, 0.0549, 0.0049, 0.000278, 7.98e-06, 8.44e-08 };
   ...
   Double_t Graph_fy6[8] = { 16.02, 2.727, 0.4068, 0.04941, 0.00441, 0.0002502, 7.182e-06, 7.596e-08 };
   ...
   Graph_Graph6->SetMinimum(6.8364e-08);
   Graph_Graph6->SetMaximum(17.622);
   ...
   Double_t Graph_fy7[8] = { 19.58, 3.333, 0.4972, 0.06039, 0.00539, 0.0003058, 8.778e-06, 9.284e-08 };
   ...
   Graph_Graph7->SetMinimum(8.3556e-08);
   Graph_Graph7->SetMaximum(21.538);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.737614,0,9.737614,2.025877e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.732614,0,"  9.74 TeV");
