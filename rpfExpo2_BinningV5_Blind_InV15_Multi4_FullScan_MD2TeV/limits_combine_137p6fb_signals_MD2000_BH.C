...
//=========  (Thu Jan 23 17:52:48 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.032033e-05);
   Graph_Graph12->SetMaximum(0.04792039);
   ...
   Graph_Graph23->SetMinimum(1.446924e-05);
   Graph_Graph23->SetMaximum(0.03117303);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.16701,0,10.16701,2.809702e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.16201,0,"  10.17 TeV");
