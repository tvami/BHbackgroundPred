...
#endif
void limits_combine_137p6fb_signals_B3_n2_MD6000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sun Mar  2 15:45:27 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[5] = { 9.763619e-05, 4.137803e-05, 2.996903e-05, 2.535823e-05, 2.254687e-05 };
   ...
   Double_t Graph1_fy2[12] = { 0.000279629, 0.0001258242, 9.11312e-05, 7.711046e-05, 6.856154e-05, 6.856154e-05, 6.693601e-06, 6.693601e-06, 7.429169e-06, 8.77999e-06, 1.212247e-05, 2.898575e-05 };
   ...
   Graph_Graph12->SetMinimum(6.024241e-06);
   Graph_Graph12->SetMaximum(0.0003069225);
   ...
   Double_t Graph2_fy3[12] = { 0.0001774185, 8.013767e-05, 5.816108e-05, 4.921287e-05, 4.384672e-05, 4.384672e-05, 1.17716e-05, 1.17716e-05, 1.317207e-05, 1.556711e-05, 2.149339e-05, 5.097534e-05 };
   ...
   Graph_Graph23->SetMinimum(1.059444e-05);
   Graph_Graph23->SetMaximum(0.0001939832);
   ...
   Double_t Graph0_fy4[5] = { 9.763619e-05, 4.137803e-05, 2.996903e-05, 2.535823e-05, 2.254687e-05 };
   ...
   Double_t Graph_fy5[5] = { 0.00124585, 8.11707e-05, 2.42174e-06, 2.15448e-08, 4.16e-11 };
   ...
   Double_t Graph_fy6[5] = { 0.001121265, 7.305363e-05, 2.179566e-06, 1.939032e-08, 3.744e-11 };
   ...
   Graph_Graph6->SetMinimum(3.3696e-11);
   Graph_Graph6->SetMaximum(0.001233391);
   ...
   Double_t Graph_fy7[5] = { 0.001370435, 8.928777e-05, 2.663914e-06, 2.369928e-08, 4.576e-11 };
   ...
   Graph_Graph7->SetMinimum(4.1184e-11);
   Graph_Graph7->SetMaximum(0.001507478);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.211258,0,8.211258,3.865211e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.206258,0,"  8.21 TeV");
