void limits_combine_96p1fb_signals_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Oct 29 13:48:01 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.574654e-05);
   Graph_Graph12->SetMaximum(0.02424909);
   ...
   Graph_Graph23->SetMinimum(2.309417e-05);
   Graph_Graph23->SetMaximum(0.01857492);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.04622,0,10.04622,4.681513e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.04122,0,"  10.05 TeV");
