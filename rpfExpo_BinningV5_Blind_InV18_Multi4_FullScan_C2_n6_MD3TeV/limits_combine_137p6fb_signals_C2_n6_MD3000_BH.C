...
#endif
void limits_combine_137p6fb_signals_C2_n6_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 11:46:13 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.004027176, 0.001123505, 0.0003131104, 9.7229e-05, 3.927917e-05, 2.416992e-05, 1.874619e-05, 1.634225e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01211362, 0.00302288, 0.0007688903, 0.0002696625, 0.0001193536, 7.349055e-05, 5.700411e-05, 4.969426e-05, 4.969426e-05, 4.851605e-06, 4.851605e-06, 5.565276e-06, 7.175446e-06, 1.196787e-05, 3.418207e-05, 0.000112524, 0.0004213142,
   0.001510191 };
   ...
   Graph_Graph12->SetMinimum(4.366445e-06);
   Graph_Graph12->SetMaximum(0.0133245);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.008008195, 0.002090826, 0.0005477477, 0.0001724154, 7.403738e-05, 4.623232e-05, 3.608196e-05, 3.158522e-05, 3.158522e-05, 8.532203e-06, 8.532203e-06, 9.787288e-06, 1.261899e-05, 2.092939e-05, 5.486935e-05, 0.0001814756, 0.0006407487,
   0.002296749 };
   ...
   Graph_Graph23->SetMinimum(7.678982e-06);
   Graph_Graph23->SetMaximum(0.008808161);
   ...
   Double_t Graph0_fy4[8] = { 0.004027176, 0.001123505, 0.0003131104, 9.7229e-05, 3.927917e-05, 2.416992e-05, 1.874619e-05, 1.634225e-05 };
   ...
   Double_t Graph_fy5[8] = { 39.1, 7.96, 1.44, 0.216, 0.0244, 0.0018, 6.93e-05, 9.98e-07 };
   ...
   Double_t Graph_fy6[8] = { 35.19, 7.164, 1.296, 0.1944, 0.02196, 0.00162, 6.237e-05, 8.982e-07 };
   ...
   Graph_Graph6->SetMinimum(8.0838e-07);
   Graph_Graph6->SetMaximum(38.709);
   ...
   Double_t Graph_fy7[8] = { 43.01, 8.756, 1.584, 0.2376, 0.02684, 0.00198, 7.623e-05, 1.0978e-06 };
   ...
   Graph_Graph7->SetMinimum(9.8802e-07);
   Graph_Graph7->SetMaximum(47.311);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.31864,0,10.31864,1.79441e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.31364,0,"  10.32 TeV");
