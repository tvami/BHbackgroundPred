...
#endif
void limits_combine_137p6fb_signals_C6_n6_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 23:24:53 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.005319214, 0.001408272, 0.000354023, 0.0001069756, 4.12262e-05, 2.466064e-05, 1.882617e-05, 1.64715e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01608882, 0.003677151, 0.0008559517, 0.0002918797, 0.0001253396, 7.498773e-05, 5.724748e-05, 5.008728e-05, 5.008728e-05, 4.889977e-06, 4.889977e-06, 5.58902e-06, 7.321129e-06, 1.256111e-05, 3.635497e-05, 0.0001299928, 0.0005060977,
   0.001911592 };
   ...
   Graph_Graph12->SetMinimum(4.400979e-06);
   Graph_Graph12->SetMaximum(0.01769721);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.01066227, 0.002598319, 0.0006136747, 0.0001884197, 7.770732e-05, 4.726927e-05, 3.62359e-05, 3.183503e-05, 3.183503e-05, 8.599683e-06, 8.599683e-06, 9.829045e-06, 1.294292e-05, 2.196684e-05, 6.007908e-05, 0.0002035027, 0.0008021236,
   0.002869986 };
   ...
   Graph_Graph23->SetMinimum(7.739715e-06);
   Graph_Graph23->SetMaximum(0.01172764);
   ...
   Double_t Graph0_fy4[8] = { 0.005319214, 0.001408272, 0.000354023, 0.0001069756, 4.12262e-05, 2.466064e-05, 1.882617e-05, 1.64715e-05 };
   ...
   Double_t Graph_fy5[8] = { 33.2, 5.51, 0.807, 0.0967, 0.00855, 0.000481, 1.35e-05, 1.39e-07 };
   ...
   Double_t Graph_fy6[8] = { 29.88, 4.959, 0.7263, 0.08703, 0.007695, 0.0004329, 1.215e-05, 1.251e-07 };
   ...
   Graph_Graph6->SetMinimum(1.1259e-07);
   Graph_Graph6->SetMaximum(32.868);
   ...
   Double_t Graph_fy7[8] = { 36.52, 6.061, 0.8877, 0.10637, 0.009405, 0.0005291, 1.485e-05, 1.529e-07 };
   ...
   Graph_Graph7->SetMinimum(1.3761e-07);
   Graph_Graph7->SetMaximum(40.172);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.899323,0,9.899323,1.934486e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.894323,0,"  9.90 TeV");
