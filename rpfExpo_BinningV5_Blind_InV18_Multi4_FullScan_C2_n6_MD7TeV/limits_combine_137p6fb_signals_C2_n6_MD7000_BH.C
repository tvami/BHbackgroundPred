...
#endif
void limits_combine_137p6fb_signals_C2_n6_MD7000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 12:00:57 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[4] = { 3.813354e-05, 2.526367e-05, 2.005805e-05, 1.764e-05 };
   ...
   Double_t Graph1_fy2[10] = { 0.0001159481, 7.682228e-05, 6.099342e-05, 5.364051e-05, 5.364051e-05, 5.236875e-06, 5.236875e-06, 5.876381e-06, 7.401466e-06, 1.13209e-05 };
   ...
   Graph_Graph12->SetMinimum(4.713188e-06);
   Graph_Graph12->SetMaximum(0.0001270192);
   ...
   Double_t Graph2_fy3[10] = { 7.324599e-05, 4.872726e-05, 3.876687e-05, 3.423406e-05, 3.423406e-05, 9.209751e-06, 9.209751e-06, 1.041895e-05, 1.312295e-05, 1.990932e-05 };
   ...
   Graph_Graph23->SetMinimum(2.806127e-06);
   Graph_Graph23->SetMaximum(7.964962e-05);
   ...
   Double_t Graph0_fy4[4] = { 3.813354e-05, 2.526367e-05, 2.005805e-05, 1.764e-05 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.769827,0,9.769827,2.115211e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.764827,0,"  9.77 TeV");
