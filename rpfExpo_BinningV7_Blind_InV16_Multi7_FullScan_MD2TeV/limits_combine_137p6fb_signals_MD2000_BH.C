...
//=========  (Wed Jan  8 11:57:43 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.2327e-05);
   Graph_Graph12->SetMaximum(0.01823191);
   ...
   Graph_Graph23->SetMinimum(1.755733e-05);
   Graph_Graph23->SetMaximum(0.01368311);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.13372,0,10.13372,3.234224e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.12872,0,"  10.13 TeV");
