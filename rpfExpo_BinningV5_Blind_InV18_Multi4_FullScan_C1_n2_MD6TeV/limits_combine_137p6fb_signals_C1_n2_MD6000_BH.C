...
#endif
void limits_combine_137p6fb_signals_C1_n2_MD6000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 09:36:23 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[5] = { 8.712036e-05, 4.029785e-05, 2.949219e-05, 2.425062e-05, 2.13964e-05 };
   ...
   Double_t Graph1_fy2[12] = { 0.0002570376, 0.0001225372, 8.968118e-05, 7.374241e-05, 6.506315e-05, 6.506315e-05, 6.352056e-06, 6.352056e-06, 7.104675e-06, 8.640289e-06, 1.180601e-05, 2.586386e-05 };
   ...
   Graph_Graph12->SetMinimum(5.716851e-06);
   Graph_Graph12->SetMaximum(0.0002821062);
   ...
   Double_t Graph2_fy3[12] = { 0.0001614352, 7.788503e-05, 5.700055e-05, 4.696667e-05, 4.152413e-05, 4.152413e-05, 1.117095e-05, 1.117095e-05, 1.259674e-05, 1.531941e-05, 2.09323e-05, 4.548508e-05 };
   ...
   Graph_Graph23->SetMinimum(1.005385e-05);
   Graph_Graph23->SetMaximum(0.0001764616);
   ...
   Double_t Graph0_fy4[5] = { 8.712036e-05, 4.029785e-05, 2.949219e-05, 2.425062e-05, 2.13964e-05 };
   ...
   Double_t Graph_fy5[5] = { 0.00667, 0.000786, 6.04e-05, 2.41e-06, 3.59e-08 };
   ...
   Double_t Graph_fy6[5] = { 0.006003, 0.0007074, 5.436e-05, 2.169e-06, 3.231e-08 };
   ...
   Graph_Graph6->SetMinimum(2.9079e-08);
   Graph_Graph6->SetMaximum(0.006603297);
   ...
   Double_t Graph_fy7[5] = { 0.007337, 0.0008646, 6.644e-05, 2.651e-06, 3.949e-08 };
   ...
   Graph_Graph7->SetMinimum(3.5541e-08);
   Graph_Graph7->SetMaximum(0.008070696);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.236927,0,9.236927,2.815607e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.231927,0,"  9.24 TeV");
