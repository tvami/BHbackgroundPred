...
#endif
void limits_combine_137p6fb_signals_C6_n2_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 23:14:11 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[9] = { 0.01549568, 0.003821182, 0.001032829, 0.0003295326, 0.0001062393, 4.267456e-05, 2.49209e-05, 1.860469e-05, 1.594515e-05 };
   ...
   5, 4, 3 };
   Double_t Graph1_fy2[20] = { 0.04686918, 0.01155778, 0.003132385, 0.0008927707, 0.0002902324, 0.0001291511, 7.577993e-05, 5.657398e-05, 4.848674e-05, 4.848674e-05, 4.733716e-06, 4.733716e-06, 5.523267e-06, 7.593086e-06, 1.383589e-05, 3.983974e-05, 0.0001338726,
   0.0004276559, 0.001612061, 0.006537241 };
   ...
   Graph_Graph12->SetMinimum(4.260345e-06);
   Graph_Graph12->SetMaximum(0.05155562);
   ...
   5, 4, 3 };
   Double_t Graph2_fy3[20] = { 0.03106083, 0.007659494, 0.002078522, 0.0006080012, 0.0001841586, 7.720539e-05, 4.677477e-05, 3.566128e-05, 3.075418e-05, 3.075418e-05, 8.324879e-06, 8.324879e-06, 9.713409e-06, 1.31434e-05, 2.352388e-05, 6.318334e-05, 0.0002026593,
   0.0006262284, 0.002371447, 0.009616705 };
   ...
   Graph_Graph23->SetMinimum(7.492391e-06);
   Graph_Graph23->SetMaximum(0.03416608);
   ...
   Double_t Graph0_fy4[9] = { 0.01549568, 0.003821182, 0.001032829, 0.0003295326, 0.0001062393, 4.267456e-05, 2.49209e-05, 1.860469e-05, 1.594515e-05 };
   ...
   Double_t Graph_fy5[9] = { 82.9, 15.9, 2.85, 0.443, 0.0557, 0.00516, 0.000302, 8.82e-06, 9.62e-08 };
   ...
   Double_t Graph_fy6[9] = { 74.61, 14.31, 2.565, 0.3987, 0.05013, 0.004644, 0.0002718, 7.938e-06, 8.658e-08 };
   ...
   Graph_Graph6->SetMinimum(7.7922e-08);
   Graph_Graph6->SetMaximum(82.071);
   ...
   Double_t Graph_fy7[9] = { 91.19, 17.49, 3.135, 0.4873, 0.06127, 0.005676, 0.0003322, 9.702e-06, 1.0582e-07 };
   ...
   Graph_Graph7->SetMinimum(9.5238e-08);
   Graph_Graph7->SetMaximum(100.309);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.769711,0,9.769711,1.990011e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.764711,0,"  9.77 TeV");
