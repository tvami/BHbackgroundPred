...
#endif
void limits_combine_137p6fb_signals_BH1_MD7000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Thu Feb 20 20:44:57 2025) by ROOT version 6.30/07
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(6.9755,-6,11.5655,0.6666667);
   ...
   Double_t Graph0_fx1[4] = { 8, 9, 10, 11 };
   Double_t Graph0_fy1[4] = { 0.0002657932, 0.0001818767, 0.0001333896, 0.0001062987 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,7.7,11.3);
   ...
   Double_t Graph1_fx2[10] = { 8, 9, 10, 11, 11, 11, 11, 10, 9, 8 };
   Double_t Graph1_fy2[10] = { 0.0005234889, 0.0003714414, 0.0003013797, 0.0002569304, 0.0002569304, 4.027723e-05, 4.027723e-05, 5.054214e-05, 6.678286e-05, 9.759594e-05 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,7.7,11.3);
   Graph_Graph12->SetMinimum(3.624951e-05);
   Graph_Graph12->SetMaximum(0.0005718101);
   ...
   Double_t Graph2_fx3[10] = { 8, 9, 10, 11, 11, 11, 11, 10, 9, 8 };
   Double_t Graph2_fy3[10] = { 0.0003992855, 0.0002815599, 0.000223778, 0.0001874393, 0.0001874393, 6.142472e-05, 6.142472e-05, 7.70792e-05, 0.0001027497, 0.0001501576 };
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,7.7,11.3);
   Graph_Graph23->SetMinimum(2.763864e-05);
   Graph_Graph23->SetMaximum(0.0004330716);
   ...
   Double_t Graph0_fx4[4] = { 8, 9, 10, 11 };
   Double_t Graph0_fy4[4] = { 0.0002657932, 0.0001818767, 0.0001333896, 0.0001062987 };
   graph = new TGraph(4,Graph0_fx4,Graph0_fy4);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,7.7,11.3);
   ...
   Double_t Graph_fx5[4] = { 8, 9, 10, 11 };
   Double_t Graph_fy5[4] = { 0.000525429, 4.18709e-05, 1.69923e-06, 2.56018e-08 };
   graph = new TGraph(4,Graph_fx5,Graph_fy5);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,7.7,11.3);
   ...
   Double_t Graph_fx6[4] = { 8, 9, 10, 11 };
   Double_t Graph_fy6[4] = { 0.0004728861, 3.768381e-05, 1.529307e-06, 2.304162e-08 };
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,7.7,11.3);
   Graph_Graph6->SetMinimum(2.073746e-08);
   Graph_Graph6->SetMaximum(0.0005201724);
   ...
   Double_t Graph_fx7[4] = { 8, 9, 10, 11 };
   Double_t Graph_fy7[4] = { 0.0005779719, 4.605799e-05, 1.869153e-06, 2.816198e-08 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,7.7,11.3);
   Graph_Graph7->SetMinimum(2.534578e-08);
   Graph_Graph7->SetMaximum(0.0006357663);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.316941,0,8.316941,0.0002356799);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.311941,0,"  8.32 TeV");
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,7.7,11.3);
