...
#endif
void limits_combine_137p6fb_signals_B2_n6_MD8000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sat Mar  1 23:28:02 2025) by ROOT version 6.30/07
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(8.317,-6,11.377,0.6666667);
   ...
   Double_t Graph0_fx1[3] = { 9, 10, 11 };
   Double_t Graph0_fy1[3] = { 2.838754e-05, 2.359288e-05, 2.066896e-05 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,8.8,11.2);
   ...
   Double_t Graph1_fx2[8] = { 9, 10, 11, 11, 11, 11, 10, 9 };
   Double_t Graph1_fy2[8] = { 8.632142e-05, 7.17423e-05, 6.285111e-05, 6.285111e-05, 6.055359e-06, 6.055359e-06, 6.911976e-06, 8.316662e-06 };
   graph = new TGraph(8,Graph1_fx2,Graph1_fy2);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,8.8,11.2);
   Graph_Graph12->SetMinimum(5.449823e-06);
   Graph_Graph12->SetMaximum(9.434802e-05);
   ...
   Double_t Graph2_fx3[8] = { 9, 10, 11, 11, 11, 11, 10, 9 };
   Double_t Graph2_fy3[8] = { 5.509187e-05, 4.578684e-05, 4.019476e-05, 4.019476e-05, 1.073628e-05, 1.073628e-05, 1.225508e-05, 1.474562e-05 };
   graph = new TGraph(8,Graph2_fx3,Graph2_fy3);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,8.8,11.2);
   Graph_Graph23->SetMinimum(6.300718e-06);
   Graph_Graph23->SetMaximum(5.952743e-05);
   ...
   Double_t Graph0_fx4[3] = { 9, 10, 11 };
   Double_t Graph0_fy4[3] = { 2.838754e-05, 2.359288e-05, 2.066896e-05 };
   graph = new TGraph(3,Graph0_fx4,Graph0_fy4);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,8.8,11.2);
   ...
   Double_t Graph_fx5[3] = { 9, 10, 11 };
   Double_t Graph_fy5[3] = { 0.000309243, 1.18427e-05, 1.72962e-07 };
   graph = new TGraph(3,Graph_fx5,Graph_fy5);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,8.8,11.2);
   ...
   Double_t Graph_fx6[3] = { 9, 10, 11 };
   Double_t Graph_fy6[3] = { 0.0002783187, 1.065843e-05, 1.556658e-07 };
   graph = new TGraph(3,Graph_fx6,Graph_fy6);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,8.8,11.2);
   Graph_Graph6->SetMinimum(1.400992e-07);
   Graph_Graph6->SetMaximum(0.000306135);
   ...
   Double_t Graph_fx7[3] = { 9, 10, 11 };
   Double_t Graph_fy7[3] = { 0.0003401673, 1.302697e-05, 1.902582e-07 };
   graph = new TGraph(3,Graph_fx7,Graph_fy7);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,8.8,11.2);
   Graph_Graph7->SetMinimum(1.712324e-07);
   Graph_Graph7->SetMaximum(0.000374165);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.776035,0,9.776035,2.459098e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.771035,0,"  9.78 TeV");
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,8.8,11.2);
