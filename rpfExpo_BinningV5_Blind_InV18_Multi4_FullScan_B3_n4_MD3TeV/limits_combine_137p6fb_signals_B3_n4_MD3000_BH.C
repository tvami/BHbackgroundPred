...
#endif
void limits_combine_137p6fb_signals_B3_n4_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sun Mar  2 15:28:53 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.005676859, 0.001438654, 0.0003715192, 0.0001030546, 3.913589e-05, 2.469289e-05, 1.92677e-05, 1.718021e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01676079, 0.003648152, 0.000850524, 0.0002846347, 0.0001190011, 7.508727e-05, 5.859011e-05, 5.224236e-05, 5.224236e-05, 5.100374e-06, 5.100374e-06, 5.7201e-06, 7.330703e-06, 1.177134e-05, 3.300969e-05, 0.0001306122, 0.0004945372,
   0.00190707 };
   ...
   Graph_Graph12->SetMinimum(4.590337e-06);
   Graph_Graph12->SetMaximum(0.01843636);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.01142442, 0.002619968, 0.0006173472, 0.0001831568, 7.470329e-05, 4.733109e-05, 3.723935e-05, 3.334174e-05, 3.334174e-05, 8.969696e-06, 8.969696e-06, 1.005957e-05, 1.289203e-05, 2.075034e-05, 5.654042e-05, 0.0002096598, 0.0007821976,
   0.00290842 };
   ...
   Graph_Graph23->SetMinimum(8.072726e-06);
   Graph_Graph23->SetMaximum(0.01256597);
   ...
   Double_t Graph0_fy4[8] = { 0.005676859, 0.001438654, 0.0003715192, 0.0001030546, 3.913589e-05, 2.469289e-05, 1.92677e-05, 1.718021e-05 };
   ...
   Double_t Graph_fy5[8] = { 14.1729, 2.35709, 0.318273, 0.0321609, 0.00197902, 5.64409e-05, 4.80192e-07, 9.001e-10 };
   ...
   Double_t Graph_fy6[8] = { 12.75561, 2.121381, 0.2864457, 0.02894481, 0.001781118, 5.079681e-05, 4.321728e-07, 8.1009e-10 };
   ...
   Graph_Graph6->SetMinimum(7.29081e-10);
   Graph_Graph6->SetMaximum(14.03117);
   ...
   Double_t Graph_fy7[8] = { 15.59019, 2.592799, 0.3501003, 0.03537699, 0.002176922, 6.208499e-05, 5.282112e-07, 9.9011e-10 };
   ...
   Graph_Graph7->SetMinimum(8.91099e-10);
   Graph_Graph7->SetMaximum(17.14921);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.182947,0,9.182947,2.359722e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.177947,0,"  9.18 TeV");
