...
#endif
void limits_combine_137p6fb_signals_C6_n6_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 23:16:37 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[9] = { 0.02039337, 0.003840637, 0.001219559, 0.0003501892, 0.0001107635, 4.416504e-05, 2.510986e-05, 1.866016e-05, 1.597425e-05 };
   ...
   5, 4, 3 };
   Double_t Graph1_fy2[20] = { 0.06063135, 0.01141856, 0.003668395, 0.0009372394, 0.0003053307, 0.0001334467, 7.635186e-05, 5.674265e-05, 4.857522e-05, 4.857522e-05, 4.742355e-06, 4.742355e-06, 5.539734e-06, 7.552576e-06, 1.449165e-05, 4.240167e-05, 0.0001367927,
   0.0004954457, 0.001680279, 0.0089221 };
   ...
   Graph_Graph12->SetMinimum(4.26812e-06);
   Graph_Graph12->SetMaximum(0.06669401);
   ...
   5, 4, 3 };
   Double_t Graph2_fy3[20] = { 0.0399027, 0.007514784, 0.00242514, 0.0006349465, 0.0001928841, 7.972588e-05, 4.712944e-05, 3.57676e-05, 3.074663e-05, 3.074663e-05, 8.340072e-06, 8.340072e-06, 9.742369e-06, 1.331356e-05, 2.446006e-05, 6.696922e-05, 0.0002101477,
   0.000721731, 0.002490413, 0.01322383 };
   ...
   Graph_Graph23->SetMinimum(7.506065e-06);
   Graph_Graph23->SetMaximum(0.04389213);
   ...
   Double_t Graph0_fy4[9] = { 0.02039337, 0.003840637, 0.001219559, 0.0003501892, 0.0001107635, 4.416504e-05, 2.510986e-05, 1.866016e-05, 1.597425e-05 };
   ...
   Double_t Graph_fy5[9] = { 486, 83.9, 13.9, 2.04, 0.244, 0.0216, 0.00121, 3.4e-05, 3.61e-07 };
   ...
   Double_t Graph_fy6[9] = { 437.4, 75.51, 12.51, 1.836, 0.2196, 0.01944, 0.001089, 3.06e-05, 3.249e-07 };
   ...
   Graph_Graph6->SetMinimum(2.9241e-07);
   Graph_Graph6->SetMaximum(481.14);
   ...
   Double_t Graph_fy7[9] = { 534.6, 92.29, 15.29, 2.244, 0.2684, 0.02376, 0.001331, 3.74e-05, 3.971e-07 };
   ...
   Graph_Graph7->SetMinimum(3.5739e-07);
   Graph_Graph7->SetMaximum(588.06);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.13667,0,10.13667,1.826798e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.13167,0,"  10.14 TeV");
