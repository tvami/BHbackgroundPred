...
#endif
void limits_combine_137p6fb_signals_B2_n6_MD4000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sat Mar  1 23:18:18 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[7] = { 0.001050636, 0.0003048834, 8.408203e-05, 3.586882e-05, 2.358686e-05, 1.924371e-05, 1.739396e-05 };
   ...
   Double_t Graph1_fy2[16] = { 0.002529481, 0.0007108243, 0.0002454014, 0.0001089931, 7.171778e-05, 5.851713e-05, 5.289234e-05, 5.289234e-05, 5.095886e-06, 5.095886e-06, 5.712975e-06, 7.002348e-06, 1.064855e-05, 2.561874e-05, 0.0001000399, 0.0003611561 };
   ...
   Graph_Graph12->SetMinimum(4.586297e-06);
   Graph_Graph12->SetMaximum(0.00278192);
   ...
   Double_t Graph2_fy3[16] = { 0.001821206, 0.0005139112, 0.0001544645, 6.875298e-05, 4.54931e-05, 3.734638e-05, 3.368722e-05, 3.368722e-05, 9.035112e-06, 9.035112e-06, 1.004704e-05, 1.231457e-05, 1.872692e-05, 4.480201e-05, 0.0001672541, 0.0005766186 };
   ...
   Graph_Graph23->SetMinimum(8.131601e-06);
   Graph_Graph23->SetMaximum(0.002002423);
   ...
   Double_t Graph0_fy4[7] = { 0.001050636, 0.0003048834, 8.408203e-05, 3.586882e-05, 2.358686e-05, 1.924371e-05, 1.739396e-05 };
   ...
   Double_t Graph_fy5[7] = { 6.71751, 1.22959, 0.18368, 0.0208951, 0.00153352, 5.97138e-05, 8.64296e-07 };
   ...
   Double_t Graph_fy6[7] = { 6.045759, 1.106631, 0.165312, 0.01880559, 0.001380168, 5.374242e-05, 7.778664e-07 };
   ...
   Graph_Graph6->SetMinimum(7.000798e-07);
   Graph_Graph6->SetMaximum(6.650335);
   ...
   Double_t Graph_fy7[7] = { 7.389261, 1.352549, 0.202048, 0.02298461, 0.001686872, 6.568518e-05, 9.507256e-07 };
   ...
   Graph_Graph7->SetMinimum(8.55653e-07);
   Graph_Graph7->SetMaximum(8.128187);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.2739,0,10.2739,1.871834e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.2689,0,"  10.27 TeV");
