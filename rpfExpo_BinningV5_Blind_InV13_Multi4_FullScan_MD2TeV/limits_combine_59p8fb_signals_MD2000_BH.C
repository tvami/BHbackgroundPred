...
//=========  (Sun Dec  1 18:40:59 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.227952e-05);
   Graph_Graph12->SetMaximum(0.0215475);
   ...
   Graph_Graph23->SetMinimum(2.024426e-05);
   Graph_Graph23->SetMaximum(0.01571023);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.06311,0,10.06311,4.358979e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.05811,0,"  10.06 TeV");
