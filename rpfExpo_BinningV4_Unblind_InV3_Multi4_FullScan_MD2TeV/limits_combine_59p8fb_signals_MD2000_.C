...
//=========  (Fri Oct 11 11:45:11 2024) by ROOT version 6.14/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(1.924,-5.021442,3.124,-0.2186953);
   ...
   Graph_Graph01->GetXaxis()->SetRange(0,9);
   ...
   Graph_Graph12->SetMinimum(0.0001075678);
   Graph_Graph12->SetMaximum(0.0004566157);
   ...
   Graph_Graph23->SetMinimum(6.242947e-05);
   Graph_Graph23->SetMaximum(0.0002984531);
   ...
   Graph_Graph_Graph014->GetXaxis()->SetRange(0,9);
   ...
   Graph_copy->GetXaxis()->SetRange(0,9);
