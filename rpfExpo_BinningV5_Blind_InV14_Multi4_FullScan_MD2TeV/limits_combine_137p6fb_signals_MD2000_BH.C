...
//=========  (Sun Dec  1 18:24:11 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(5.948772e-06);
   Graph_Graph12->SetMaximum(0.01350865);
   ...
   Graph_Graph23->SetMinimum(9.549019e-06);
   Graph_Graph23->SetMaximum(0.0103112);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.24508,0,10.24508,2.019998e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.24008,0,"  10.25 TeV");
