...
#endif
void limits_combine_137p6fb_signals_BH1_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Wed Feb 26 23:06:40 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.003288554, 0.001035551, 0.0003703693, 0.0001632829, 8.665018e-05, 5.658821e-05, 4.339127e-05, 3.639762e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.009982501, 0.003075805, 0.00104074, 0.0004553785, 0.0002512507, 0.0001672643, 0.0001277103, 0.0001073339, 0.0001073339, 1.507089e-05, 1.507089e-05, 1.79667e-05, 2.343106e-05, 3.689402e-05, 7.398758e-05, 0.0001736106, 0.0004854146,
   0.00154151 };
   ...
   Graph_Graph12->SetMinimum(1.35638e-05);
   Graph_Graph12->SetMaximum(0.01097924);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.005516968, 0.001708374, 0.0006051022, 0.0002700228, 0.000147439, 9.741512e-05, 7.486989e-05, 6.30928e-05, 6.30928e-05, 2.223534e-05, 2.223534e-05, 2.650776e-05, 3.482883e-05, 5.39977e-05, 0.0001053805, 0.0002427836, 0.0006788219,
   0.002142056 };
   ...
   Graph_Graph23->SetMinimum(2.001181e-05);
   Graph_Graph23->SetMaximum(0.006066442);
   ...
   Double_t Graph0_fy4[8] = { 0.003288554, 0.001035551, 0.0003703693, 0.0001632829, 8.665018e-05, 5.658821e-05, 4.339127e-05, 3.639762e-05 };
   ...
   Double_t Graph_fy5[8] = { 6.78799, 1.55122, 0.301522, 0.0486405, 0.00584229, 0.000454481, 1.8391e-05, 2.76788e-07 };
   ...
   Double_t Graph_fy6[8] = { 6.109191, 1.396098, 0.2713698, 0.04377645, 0.005258061, 0.0004090329, 1.65519e-05, 2.491092e-07 };
   ...
   Graph_Graph6->SetMinimum(2.241983e-07);
   Graph_Graph6->SetMaximum(6.72011);
   ...
   Double_t Graph_fy7[8] = { 7.466789, 1.706342, 0.3316742, 0.05350455, 0.006426519, 0.0004999291, 2.02301e-05, 3.044668e-07 };
   ...
   Graph_Graph7->SetMinimum(2.740201e-07);
   Graph_Graph7->SetMaximum(8.213468);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.708202,0,9.708202,4.688711e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.703202,0,"  9.71 TeV");
