...
#endif
void limits_combine_137p6fb_signals_B1_n6_MD9000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Feb 28 00:25:59 2025) by ROOT version 6.30/07
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(9.6585,-6,11.1885,0.6666667);
   ...
   Double_t Graph0_fx1[2] = { 10, 11 };
   Double_t Graph0_fy1[2] = { 2.575327e-05, 2.272373e-05 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,9.9,11.1);
   ...
   Double_t Graph1_fx2[6] = { 10, 11, 11, 11, 11, 10 };
   Double_t Graph1_fy2[6] = { 7.831173e-05, 6.909935e-05, 6.909935e-05, 6.657342e-06, 6.657342e-06, 7.544904e-06 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,9.9,11.1);
   Graph_Graph12->SetMinimum(5.991608e-06);
   Graph_Graph12->SetMaximum(8.547717e-05);
   ...
   Double_t Graph2_fx3[6] = { 10, 11, 11, 11, 11, 10 };
   Double_t Graph2_fy3[6] = { 4.987688e-05, 4.410008e-05, 4.410008e-05, 1.180361e-05, 1.180361e-05, 1.337727e-05 };
   graph = new TGraph(6,Graph2_fx3,Graph2_fy3);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,9.9,11.1);
   Graph_Graph23->SetMinimum(7.996279e-06);
   Graph_Graph23->SetMaximum(5.368421e-05);
   ...
   Double_t Graph0_fx4[2] = { 10, 11 };
   Double_t Graph0_fy4[2] = { 2.575327e-05, 2.272373e-05 };
   graph = new TGraph(2,Graph0_fx4,Graph0_fy4);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,9.9,11.1);
   ...
   Double_t Graph_fx5[2] = { 10, 11 };
   Double_t Graph_fy5[2] = { 9.10613e-06, 1.33277e-07 };
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,9.9,11.1);
   ...
   Double_t Graph_fx6[2] = { 10, 11 };
   Double_t Graph_fy6[2] = { 8.195517e-06, 1.199493e-07 };
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,9.9,11.1);
   Graph_Graph6->SetMinimum(1.079544e-07);
   Graph_Graph6->SetMaximum(9.003074e-06);
   ...
   Double_t Graph_fx7[2] = { 10, 11 };
   Double_t Graph_fy7[2] = { 1.001674e-05, 1.466047e-07 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,9.9,11.1);
   Graph_Graph7->SetMinimum(1.319442e-07);
   Graph_Graph7->SetMaximum(1.100376e-05);
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,9.9,11.1);
