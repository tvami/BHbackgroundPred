...
//=========  (Mon Oct 14 19:02:09 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.561872e-05);
   Graph_Graph12->SetMaximum(0.03222537);
   ...
   Graph_Graph23->SetMinimum(2.466128e-05);
   Graph_Graph23->SetMaximum(0.02415182);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.01174,0,10.01174,5.415939e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.00674,0,"  10.01 TeV");
