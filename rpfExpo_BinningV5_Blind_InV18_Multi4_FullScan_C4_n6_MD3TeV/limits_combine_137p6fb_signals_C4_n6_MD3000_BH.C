...
#endif
void limits_combine_137p6fb_signals_C4_n6_MD3000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 18:21:36 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 0.00493927, 0.001534386, 0.0003724937, 0.0001091888, 4.070435e-05, 2.454321e-05, 1.908984e-05, 1.6445e-05 };
   ...
   4 };
   Double_t Graph1_fy2[18] = { 0.01485717, 0.003841695, 0.000891539, 0.0002947309, 0.000123753, 7.463063e-05, 5.804926e-05, 5.00067e-05, 5.00067e-05, 4.882109e-06, 4.882109e-06, 5.667297e-06, 7.286266e-06, 1.240211e-05, 3.753366e-05, 0.000136775, 0.0005514199,
   0.001697874 };
   ...
   Graph_Graph12->SetMinimum(4.393898e-06);
   Graph_Graph12->SetMaximum(0.0163424);
   ...
   4 };
   Double_t Graph2_fy3[18] = { 0.00982193, 0.002782076, 0.000642723, 0.0001905771, 7.672369e-05, 4.684852e-05, 3.67434e-05, 3.184936e-05, 3.184936e-05, 8.585848e-06, 8.585848e-06, 9.966707e-06, 1.281388e-05, 2.168878e-05, 6.160533e-05, 0.0002141202, 0.0008432378,
   0.002609517 };
   ...
   Graph_Graph23->SetMinimum(7.727263e-06);
   Graph_Graph23->SetMaximum(0.01080326);
   ...
   Double_t Graph0_fy4[8] = { 0.00493927, 0.001534386, 0.0003724937, 0.0001091888, 4.070435e-05, 2.454321e-05, 1.908984e-05, 1.6445e-05 };
   ...
   Double_t Graph_fy5[8] = { 33.2, 5.51, 0.807, 0.0967, 0.00855, 0.000481, 1.35e-05, 1.43e-07 };
   ...
   Double_t Graph_fy6[8] = { 29.88, 4.959, 0.7263, 0.08703, 0.007695, 0.0004329, 1.215e-05, 1.287e-07 };
   ...
   Graph_Graph6->SetMinimum(1.1583e-07);
   ...
   Double_t Graph_fy7[8] = { 36.52, 6.061, 0.8877, 0.10637, 0.009405, 0.0005291, 1.485e-05, 1.573e-07 };
   ...
   Graph_Graph7->SetMinimum(1.4157e-07);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.895702,0,9.895702,1.959676e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.890702,0,"  9.90 TeV");
