void limits_combine_59p8fb_signals_MD2000_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Oct 14 11:40:15 2024) by ROOT version 6.14/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(0.4,-4.79782,12.4,-1.41551);
   ...
   Graph_Graph01->SetMinimum(5.123029e-05);
   Graph_Graph01->SetMaximum(0.01763026);
   ...
   Graph_Graph12->SetMinimum(2.08123e-05);
   Graph_Graph12->SetMaximum(0.03059038);
   ...
   Graph_Graph23->SetMinimum(3.126849e-05);
   Graph_Graph23->SetMaximum(0.02353748);
   ...
   Graph_Graph_Graph014->SetMinimum(5.123029e-05);
   Graph_Graph_Graph014->SetMaximum(0.01763026);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("Graph1","#pm1#sigma, 2#sigma","f");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("Graph1","#pm2#sigma","f");
   ...
   Graph_copy->SetMinimum(5.123029e-05);
   Graph_copy->SetMaximum(0.01763026);
   ...
   TLatex *   tex = new TLatex(0.95,0.915,"60 fb^{-1} (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
