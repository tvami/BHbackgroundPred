...
//=========  (Mon Oct 14 19:04:10 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(2.395774e-05);
   Graph_Graph12->SetMaximum(0.003790926);
   ...
   Graph_Graph23->SetMinimum(3.782823e-05);
   Graph_Graph23->SetMaximum(0.002700361);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.223531,0,9.223531,9.993559e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.218531,0,"  9.22 TeV");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.3,0.96,"Internal Simulation");
tex->SetNDC();
   tex->SetTextAlign(13);
   tex->SetTextFont(52);
