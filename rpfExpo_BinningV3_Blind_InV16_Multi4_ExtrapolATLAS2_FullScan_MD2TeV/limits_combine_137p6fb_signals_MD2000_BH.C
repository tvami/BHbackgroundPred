...
//=========  (Wed Jan 22 18:22:55 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(6.546571e-06);
   Graph_Graph12->SetMaximum(0.0464825);
   ...
   Graph_Graph23->SetMinimum(1.044147e-05);
   Graph_Graph23->SetMaximum(0.02764809);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.20776,0,10.20776,2.365143e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.20276,0,"  10.21 TeV");
