...
#endif
void limits_combine_137p6fb_signals_B3_n2_MD5000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sun Mar  2 15:30:36 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[6] = { 0.0003427776, 8.35388e-05, 4.175096e-05, 2.816493e-05, 2.266113e-05, 2.011256e-05 };
   ...
   Double_t Graph1_fy2[14] = { 0.0007484149, 0.0002521367, 0.0001269582, 8.56452e-05, 6.890898e-05, 6.11592e-05, 6.11592e-05, 5.970918e-06, 5.970918e-06, 6.639002e-06, 8.251445e-06, 1.223173e-05, 2.480058e-05, 0.000105779 };
   ...
   Graph_Graph12->SetMinimum(5.373826e-06);
   Graph_Graph12->SetMaximum(0.0008226593);
   ...
   Double_t Graph2_fy3[14] = { 0.000545677, 0.0001571294, 8.06935e-05, 5.454759e-05, 4.397859e-05, 3.911275e-05, 3.911275e-05, 1.050066e-05, 1.050066e-05, 1.177109e-05, 1.462998e-05, 2.168711e-05, 4.361517e-05, 0.0001835442 };
   ...
   Graph_Graph23->SetMinimum(9.450598e-06);
   Graph_Graph23->SetMaximum(0.0005991946);
   ...
   Double_t Graph0_fy4[6] = { 0.0003427776, 8.35388e-05, 4.175096e-05, 2.816493e-05, 2.266113e-05, 2.011256e-05 };
   ...
   Double_t Graph_fy5[6] = { 0.0197055, 0.00212531, 0.000136156, 4.05981e-06, 3.57431e-08, 6.92e-11 };
   ...
   Double_t Graph_fy6[6] = { 0.01773495, 0.001912779, 0.0001225404, 3.653829e-06, 3.216879e-08, 6.228e-11 };
   ...
   Graph_Graph6->SetMinimum(5.6052e-11);
   Graph_Graph6->SetMaximum(0.01950844);
   ...
   Double_t Graph_fy7[6] = { 0.02167605, 0.002337841, 0.0001497716, 4.465791e-06, 3.931741e-08, 7.612e-11 };
   ...
   Graph_Graph7->SetMinimum(6.8508e-11);
   Graph_Graph7->SetMaximum(0.02384365);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.37899,0,8.37899,3.596459e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.37399,0,"  8.38 TeV");
