...
#endif
void limits_combine_137p6fb_signals_C3_n6_MD4000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 16:14:45 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[7] = { 0.001559715, 0.0003966217, 0.0001033936, 3.979797e-05, 2.482837e-05, 1.949258e-05, 1.699638e-05 };
   ...
   Double_t Graph1_fy2[16] = { 0.003596687, 0.0008640274, 0.0002881185, 0.000120976, 7.549606e-05, 5.927392e-05, 5.168335e-05, 5.168335e-05, 5.045799e-06, 5.045799e-06, 5.710716e-06, 7.370922e-06, 1.197048e-05, 3.271437e-05, 0.0001363387, 0.0005117816 };
   ...
   Graph_Graph12->SetMinimum(4.541219e-06);
   Graph_Graph12->SetMaximum(0.003955851);
   ...
   Double_t Graph2_fy3[16] = { 0.002616621, 0.0006337644, 0.0001849955, 7.612571e-05, 4.77887e-05, 3.767397e-05, 3.291722e-05, 3.291722e-05, 8.873718e-06, 8.873718e-06, 1.012522e-05, 1.296276e-05, 2.088398e-05, 5.590598e-05, 0.0002217441, 0.0008228869 };
   ...
   Graph_Graph23->SetMinimum(7.986346e-06);
   Graph_Graph23->SetMaximum(0.002877396);
   ...
   Double_t Graph0_fy4[7] = { 0.001559715, 0.0003966217, 0.0001033936, 3.979797e-05, 2.482837e-05, 1.949258e-05, 1.699638e-05 };
   ...
   Double_t Graph_fy5[7] = { 4.13, 0.748, 0.112, 0.0126, 0.000933, 3.59e-05, 5.17e-07 };
   ...
   Double_t Graph_fy6[7] = { 3.717, 0.6732, 0.1008, 0.01134, 0.0008397, 3.231e-05, 4.653e-07 };
   ...
   Graph_Graph6->SetMinimum(4.1877e-07);
   Graph_Graph6->SetMaximum(4.0887);
   ...
   Double_t Graph_fy7[7] = { 4.543, 0.8228, 0.1232, 0.01386, 0.0010263, 3.949e-05, 5.687e-07 };
   ...
   Graph_Graph7->SetMinimum(5.1183e-07);
   Graph_Graph7->SetMaximum(4.9973);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.14883,0,10.14883,1.909906e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.14383,0,"  10.15 TeV");
