...
//=========  (Thu Jan 23 16:56:49 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.465684e-05);
   Graph_Graph12->SetMaximum(0.02672389);
   ...
   Graph_Graph23->SetMinimum(2.087573e-05);
   Graph_Graph23->SetMaximum(0.01766409);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.08798,0,10.08798,3.92398e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.08298,0,"  10.09 TeV");
