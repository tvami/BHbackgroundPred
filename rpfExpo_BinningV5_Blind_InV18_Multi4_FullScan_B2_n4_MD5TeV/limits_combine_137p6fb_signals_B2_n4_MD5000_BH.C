...
#endif
void limits_combine_137p6fb_signals_B2_n4_MD5000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sat Mar  1 23:02:25 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[6] = { 0.0002823517, 8.350137e-05, 3.661626e-05, 2.462536e-05, 2.05509e-05, 1.823805e-05 };
   ...
   Double_t Graph1_fy2[14] = { 0.0006483876, 0.0002461665, 0.0001113247, 7.488045e-05, 6.249212e-05, 5.545908e-05, 5.545908e-05, 5.343178e-06, 5.343178e-06, 6.020773e-06, 7.310653e-06, 1.087045e-05, 2.511565e-05, 9.044078e-05 };
   ...
   Graph_Graph12->SetMinimum(4.80886e-06);
   Graph_Graph12->SetMaximum(0.000712692);
   ...
   Double_t Graph2_fy3[14] = { 0.0004658027, 0.0001547291, 7.033164e-05, 4.769242e-05, 3.980135e-05, 3.532199e-05, 3.532199e-05, 9.473566e-06, 9.473566e-06, 1.067496e-05, 1.285677e-05, 1.911716e-05, 4.427346e-05, 0.0001534116 };
   ...
   Graph_Graph23->SetMinimum(8.526209e-06);
   Graph_Graph23->SetMaximum(0.0005114356);
   ...
   Double_t Graph0_fy4[6] = { 0.0002823517, 8.350137e-05, 3.661626e-05, 2.462536e-05, 2.05509e-05, 1.823805e-05 };
   ...
   Double_t Graph_fy5[6] = { 0.327508, 0.0497486, 0.00576847, 0.000432899, 1.69165e-05, 2.44806e-07 };
   ...
   Double_t Graph_fy6[6] = { 0.2947572, 0.04477374, 0.005191623, 0.0003896091, 1.522485e-05, 2.203254e-07 };
   ...
   Graph_Graph6->SetMinimum(1.982929e-07);
   Graph_Graph6->SetMaximum(0.3242329);
   ...
   Double_t Graph_fy7[6] = { 0.3602588, 0.05472346, 0.006345317, 0.0004761889, 1.860815e-05, 2.692866e-07 };
   ...
   Graph_Graph7->SetMinimum(2.423579e-07);
   Graph_Graph7->SetMaximum(0.3962847);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.936428,0,9.936428,2.078857e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.931428,0,"  9.94 TeV");
