...
//=========  (Thu Jan  9 19:35:47 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(9.698434e-06);
   Graph_Graph12->SetMaximum(0.05220674);
   ...
   Graph_Graph23->SetMinimum(1.495124e-05);
   Graph_Graph23->SetMaximum(0.03459715);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.09614,0,10.09614,3.790957e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.09114,0,"  10.10 TeV");
