void limits_combine_137p6fb_signals_BH1_MD2000_BH()
{
...
//=========  (Tue Jan 28 13:50:20 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMaximum(0.04421528);
   ...
   Graph_Graph23->SetMaximum(0.02629968);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.2783,0,10.2783,1.755392e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.2733,0,"  10.28 TeV");
