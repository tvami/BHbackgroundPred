...
#endif
void limits_combine_137p6fb_signals_C3_n6_MD6000_BH()
{
...
//=========  (Fri Mar  7 16:21:51 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[5] = { 0.0001037605, 3.997803e-05, 2.53147e-05, 1.985781e-05, 1.75275e-05 };
   ...
   Double_t Graph1_fy2[12] = { 0.0002876967, 0.0001215454, 7.697658e-05, 6.038454e-05, 5.329842e-05, 5.329842e-05, 5.13501e-06, 5.13501e-06, 5.817719e-06, 7.515301e-06, 1.186848e-05, 3.201985e-05 };
   ...
   Graph_Graph12->SetMinimum(4.621509e-06);
   Graph_Graph12->SetMaximum(0.0003159529);
   ...
   Double_t Graph2_fy3[12] = { 0.0001848249, 7.662948e-05, 4.882567e-05, 3.845902e-05, 3.3876e-05, 3.3876e-05, 9.104479e-06, 9.104479e-06, 1.031494e-05, 1.321667e-05, 2.087232e-05, 5.555976e-05 };
   ...
   Graph_Graph23->SetMinimum(8.194031e-06);
   Graph_Graph23->SetMaximum(0.000202397);
   ...
   Double_t Graph0_fy4[5] = { 0.0001037605, 3.997803e-05, 2.53147e-05, 1.985781e-05, 1.75275e-05 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.888762,0,9.888762,2.040142e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.883762,0,"  9.89 TeV");
