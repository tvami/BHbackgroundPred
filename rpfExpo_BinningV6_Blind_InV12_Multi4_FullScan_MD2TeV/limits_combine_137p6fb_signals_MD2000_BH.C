...
//=========  (Tue Jan  7 14:38:57 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.236936e-05);
   Graph_Graph12->SetMaximum(0.0228867);
   ...
   Graph_Graph23->SetMinimum(1.761767e-05);
   Graph_Graph23->SetMaximum(0.01789873);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.12727,0,10.12727,3.323587e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.12227,0,"  10.13 TeV");
