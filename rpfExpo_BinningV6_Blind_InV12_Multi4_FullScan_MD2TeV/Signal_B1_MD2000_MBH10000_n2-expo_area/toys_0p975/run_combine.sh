...
combine -M HybridNew -H AsymptoticLimits -d $cardname -v 1 --LHCmode LHC-limits --plot=limit_scan_card_${exp_quantile}.png -m 125 --expectedFromGrid=${exp_quantile} --rRelAcc 0.005 --rAbsAcc 0.0005 --rMin 0.8 --rMax 3.0 --adaptiveToys 1 -T 500
