...
#endif
void limits_combine_137p6fb_signals_B1_n6_MD6000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Feb 28 00:21:09 2025) by ROOT version 6.30/07
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(5.634,-6,11.754,0.6666667);
   ...
   Double_t Graph0_fx1[5] = { 7, 8, 9, 10, 11 };
   Double_t Graph0_fy1[5] = { 8.081173e-05, 3.688607e-05, 2.496797e-05, 2.011756e-05, 1.797166e-05 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,6.6,11.4);
   ...
   Double_t Graph1_fx2[12] = { 7, 8, 9, 10, 11, 11, 11, 11, 10, 9, 8, 7 };
   Double_t Graph1_fy2[12] = { 0.0002401688, 0.000112125, 7.592225e-05, 6.117439e-05, 5.464905e-05, 5.464905e-05, 5.265135e-06, 5.265135e-06, 5.893817e-06, 7.314834e-06, 1.080647e-05, 2.399098e-05 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,6.6,11.4);
   Graph_Graph12->SetMinimum(4.738622e-06);
   Graph_Graph12->SetMaximum(0.0002636592);
   ...
   Double_t Graph2_fx3[12] = { 7, 8, 9, 10, 11, 11, 11, 11, 10, 9, 8, 7 };
   Double_t Graph2_fy3[12] = { 0.0001507116, 7.099691e-05, 4.825644e-05, 3.904227e-05, 3.473444e-05, 3.473444e-05, 9.335195e-06, 9.335195e-06, 1.044986e-05, 1.296935e-05, 1.916009e-05, 4.219138e-05 };
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,6.6,11.4);
   Graph_Graph23->SetMinimum(8.401675e-06);
   Graph_Graph23->SetMaximum(0.0001648492);
   ...
   Double_t Graph0_fx4[5] = { 7, 8, 9, 10, 11 };
   Double_t Graph0_fy4[5] = { 8.081173e-05, 3.688607e-05, 2.496797e-05, 2.011756e-05, 1.797166e-05 };
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,6.6,11.4);
   ...
   Graph_Graph04->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fx5[5] = { 7, 8, 9, 10, 11 };
   Double_t Graph_fy5[5] = { 0.0723014, 0.00827865, 0.000612388, 2.33036e-05, 3.37496e-07 };
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,6.6,11.4);
   ...
   Double_t Graph_fx6[5] = { 7, 8, 9, 10, 11 };
   Double_t Graph_fy6[5] = { 0.06507126, 0.007450785, 0.0005511492, 2.097324e-05, 3.037464e-07 };
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,6.6,11.4);
   Graph_Graph6->SetMinimum(2.733718e-07);
   Graph_Graph6->SetMaximum(0.07157836);
   ...
   Double_t Graph_fx7[5] = { 7, 8, 9, 10, 11 };
   Double_t Graph_fy7[5] = { 0.07953154, 0.009106515, 0.0006736268, 2.563396e-05, 3.712456e-07 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,6.6,11.4);
   Graph_Graph7->SetMinimum(3.34121e-07);
   Graph_Graph7->SetMaximum(0.08748466);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.03567,0,10.03567,2.003679e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.03067,0,"  10.04 TeV");
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,6.6,11.4);
