...
#endif
void limits_combine_137p6fb_signals_B3_n2_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sun Mar  2 15:01:52 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[9] = { 0.01652851, 0.004276901, 0.001243944, 0.0003655054, 0.000101737, 3.96434e-05, 2.378378e-05, 1.835048e-05, 1.610388e-05 };
   ...
   5, 4, 3 };
   Double_t Graph1_fy2[20] = { 0.04933121, 0.01297107, 0.003688074, 0.0008558189, 0.0002789527, 0.0001205441, 7.232278e-05, 5.580096e-05, 4.896941e-05, 4.896941e-05, 4.780839e-06, 4.780839e-06, 5.447797e-06, 7.060808e-06, 1.207885e-05, 3.417726e-05, 0.000134209,
   0.0004616198, 0.001637251, 0.007360352 };
   ...
   Graph_Graph12->SetMinimum(4.302755e-06);
   Graph_Graph12->SetMaximum(0.05426385);
   ...
   5, 4, 3 };
   Double_t Graph2_fy3[20] = { 0.03326288, 0.008607071, 0.002508339, 0.0006175527, 0.0001795983, 7.424984e-05, 4.530409e-05, 3.532029e-05, 3.118871e-05, 3.118871e-05, 8.407751e-06, 8.407751e-06, 9.580686e-06, 1.241738e-05, 2.112347e-05, 5.68731e-05, 0.0002119102,
   0.0006999841, 0.002420897, 0.0102254 };
   ...
   Graph_Graph23->SetMinimum(7.566976e-06);
   Graph_Graph23->SetMaximum(0.03658833);
   ...
   Double_t Graph0_fy4[9] = { 0.01652851, 0.004276901, 0.001243944, 0.0003655054, 0.000101737, 3.96434e-05, 2.378378e-05, 1.835048e-05, 1.610388e-05 };
   ...
   Double_t Graph_fy5[9] = { 50.9747, 10.1924, 1.84233, 0.260367, 0.0276657, 0.00176021, 5.15987e-05, 4.51704e-07, 8.775e-10 };
   ...
   Double_t Graph_fy6[9] = { 45.87723, 9.17316, 1.658097, 0.2343303, 0.02489913, 0.001584189, 4.643883e-05, 4.065336e-07, 7.8975e-10 };
   ...
   Graph_Graph6->SetMinimum(7.10775e-10);
   Graph_Graph6->SetMaximum(50.46495);
   ...
   Double_t Graph_fy7[9] = { 56.07217, 11.21164, 2.026563, 0.2864037, 0.03043227, 0.001936231, 5.675857e-05, 4.968744e-07, 9.6525e-10 };
   ...
   Graph_Graph7->SetMinimum(8.68725e-10);
   Graph_Graph7->SetMaximum(61.67939);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.172921,0,9.172921,2.274071e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.167921,0,"  9.17 TeV");
