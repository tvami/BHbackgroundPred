...
#endif
void limits_combine_137p6fb_signals_C2_n4_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 11:46:00 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[9] = { 0.01441956, 0.003135681, 0.0009132385, 0.0002978134, 0.0001013184, 4.244385e-05, 2.458374e-05, 1.832227e-05, 1.598438e-05 };
   ...
   5, 4, 3 };
   Double_t Graph1_fy2[20] = { 0.0427557, 0.009322666, 0.002745173, 0.0008303748, 0.0002778995, 0.0001284529, 7.474863e-05, 5.571502e-05, 4.860601e-05, 4.860601e-05, 4.682922e-06, 4.682922e-06, 5.439423e-06, 7.490358e-06, 1.376109e-05, 3.799438e-05, 0.0001209867,
   0.0003710032, 0.001371861, 0.006308556 };
   ...
   Graph_Graph12->SetMinimum(4.21463e-06);
   Graph_Graph12->SetMaximum(0.0470308);
   ...
   5, 4, 3 };
   Double_t Graph2_fy3[20] = { 0.02637476, 0.006135431, 0.001757767, 0.0005352328, 0.0001748208, 7.6788e-05, 4.633793e-05, 3.511993e-05, 3.07024e-05, 3.07024e-05, 8.302919e-06, 8.302919e-06, 9.565958e-06, 1.309912e-05, 2.33967e-05, 6.075144e-05, 0.0001928226,
   0.0005404517, 0.002033293, 0.009350181 };
   ...
   Graph_Graph23->SetMinimum(7.472627e-06);
   Graph_Graph23->SetMaximum(0.02901141);
   ...
   Double_t Graph0_fy4[9] = { 0.01441956, 0.003135681, 0.0009132385, 0.0002978134, 0.0001013184, 4.244385e-05, 2.458374e-05, 1.832227e-05, 1.598438e-05 };
   ...
   Double_t Graph_fy5[9] = { 252, 54.8, 11.4, 2.11, 0.32, 0.0366, 0.00274, 0.000106, 1.55e-06 };
   ...
   Double_t Graph_fy6[9] = { 226.8, 49.32, 10.26, 1.899, 0.288, 0.03294, 0.002466, 9.54e-05, 1.395e-06 };
   ...
   Graph_Graph6->SetMinimum(1.2555e-06);
   Graph_Graph6->SetMaximum(249.48);
   ...
   Double_t Graph_fy7[9] = { 277.2, 60.28, 12.54, 2.321, 0.352, 0.04026, 0.003014, 0.0001166, 1.705e-06 };
   ...
   Graph_Graph7->SetMinimum(1.5345e-06);
   Graph_Graph7->SetMaximum(304.92);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.42931,0,10.42931,1.727937e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.42431,0,"  10.43 TeV");
