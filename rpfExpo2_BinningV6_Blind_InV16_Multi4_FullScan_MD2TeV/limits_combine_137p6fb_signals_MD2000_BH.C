...
//=========  (Mon Jan 20 14:52:42 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(9.599836e-06);
   Graph_Graph12->SetMaximum(0.0522636);
   ...
   Graph_Graph23->SetMinimum(1.416344e-05);
   Graph_Graph23->SetMaximum(0.03851934);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(10.16716,0,10.16716,2.80788e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.16216,0,"  10.17 TeV");
