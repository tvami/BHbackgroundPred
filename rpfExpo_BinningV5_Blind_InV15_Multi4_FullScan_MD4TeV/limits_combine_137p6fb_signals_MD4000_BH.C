...
//=========  (Wed Dec 11 23:13:05 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.754615e-05);
   Graph_Graph12->SetMaximum(0.004550436);
   ...
   Graph_Graph23->SetMinimum(2.630193e-05);
   Graph_Graph23->SetMaximum(0.002623078);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.350523,0,9.350523,6.643771e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.345523,0,"  9.35 TeV");
