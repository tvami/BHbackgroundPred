...
//=========  (Fri Jan 10 16:16:33 2025) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(7.784471e-06);
   Graph_Graph12->SetMaximum(0.004253197);
   ...
   Graph_Graph23->SetMinimum(1.271888e-05);
   Graph_Graph23->SetMaximum(0.003385824);
   ...
   Graph_Graph_Graph014->GetXaxis()->SetRange(0,99);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.527304,0,9.527304,3.763516e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.522304,0,"  9.53 TeV");
