...
//=========  (Tue Oct 15 17:13:56 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.752861e-05);
   Graph_Graph12->SetMaximum(0.0391868);
   ...
   Graph_Graph23->SetMinimum(2.692833e-05);
   Graph_Graph23->SetMaximum(0.02966137);
