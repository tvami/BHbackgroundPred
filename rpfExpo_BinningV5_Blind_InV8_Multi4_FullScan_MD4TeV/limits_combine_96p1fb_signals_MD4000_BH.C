void limits_combine_96p1fb_signals_MD4000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Oct 29 13:50:51 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(2.519356e-05);
   Graph_Graph12->SetMaximum(0.003039901);
   ...
   Graph_Graph23->SetMinimum(3.694936e-05);
   Graph_Graph23->SetMaximum(0.002188977);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.253773,0,9.253773,9.067684e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.248773,0,"  9.25 TeV");
   ...
   Graph_copy->Draw("sameaxis");
      tex = new TLatex(0.95,0.915,"35.9 fb^{-1} + 60 fb^{-1} (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
