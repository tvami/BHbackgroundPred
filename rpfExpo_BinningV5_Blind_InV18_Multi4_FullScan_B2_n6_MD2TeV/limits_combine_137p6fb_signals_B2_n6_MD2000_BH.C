...
#endif
void limits_combine_137p6fb_signals_B2_n6_MD2000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sat Mar  1 23:25:51 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[9] = { 0.01478359, 0.00315115, 0.001145754, 0.0003019977, 8.698483e-05, 3.500793e-05, 2.223727e-05, 1.780847e-05, 1.584206e-05 };
   ...
   5, 4, 3 };
   Double_t Graph1_fy2[20] = { 0.03316914, 0.009079761, 0.002780748, 0.0007245229, 0.0002396306, 0.0001061379, 6.759578e-05, 5.415175e-05, 4.817326e-05, 4.817326e-05, 4.703112e-06, 4.703112e-06, 5.217326e-06, 6.601688e-06, 1.066648e-05, 2.990103e-05, 9.437428e-05,
   0.0004296577, 0.0007877874, 0.003695898 };
   ...
   Graph_Graph12->SetMinimum(4.232801e-06);
   Graph_Graph12->SetMaximum(0.03648558);
   ...
   5, 4, 3 };
   Double_t Graph2_fy3[20] = { 0.02609777, 0.005562788, 0.001876478, 0.0004753414, 0.0001507823, 6.598651e-05, 4.253553e-05, 3.427707e-05, 3.068164e-05, 3.068164e-05, 8.271056e-06, 8.271056e-06, 9.250427e-06, 1.160996e-05, 1.865352e-05, 4.773972e-05, 0.0001722331,
   0.0006981938, 0.002560309, 0.006467822 };
   ...
   Graph_Graph23->SetMinimum(7.443951e-06);
   Graph_Graph23->SetMaximum(0.02870672);
   ...
   Double_t Graph0_fy4[9] = { 0.01478359, 0.00315115, 0.001145754, 0.0003019977, 8.698483e-05, 3.500793e-05, 2.223727e-05, 1.780847e-05, 1.584206e-05 };
   ...
   Double_t Graph_fy5[9] = { 775.086, 165.211, 33.3725, 6.08976, 0.912102, 0.101968, 0.00759032, 0.000291774, 4.26005e-06 };
   ...
   Double_t Graph_fy6[9] = { 697.5774, 148.6899, 30.03525, 5.480784, 0.8208918, 0.0917712, 0.006831288, 0.0002625966, 3.834045e-06 };
   ...
   Graph_Graph6->SetMinimum(3.450641e-06);
   Graph_Graph6->SetMaximum(767.3351);
   ...
   Double_t Graph_fy7[9] = { 852.5946, 181.7321, 36.70975, 6.698736, 1.003312, 0.1121648, 0.008349352, 0.0003209514, 4.686055e-06 };
   ...
   Graph_Graph7->SetMinimum(4.21745e-06);
   Graph_Graph7->SetMaximum(937.8541);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(10.68042,0,10.68042,1.644566e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(10.67542,0,"  10.68 TeV");
