...
#endif
void limits_combine_137p6fb_signals_C4_n4_MD5000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Mar  7 18:28:16 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[6] = { 0.0003937073, 0.0001036713, 3.972656e-05, 2.494219e-05, 2.003625e-05, 1.74344e-05 };
   ...
   Double_t Graph1_fy2[14] = { 0.0008377001, 0.0002874492, 0.0001207972, 7.584534e-05, 6.092714e-05, 5.301532e-05, 5.301532e-05, 5.175837e-06, 5.175837e-06, 5.869995e-06, 7.404712e-06, 1.179382e-05, 3.239727e-05, 0.000132261 };
   ...
   Graph_Graph12->SetMinimum(4.658254e-06);
   Graph_Graph12->SetMaximum(0.0009209525);
   ...
   Double_t Graph2_fy3[14] = { 0.0006165527, 0.0001846659, 7.614747e-05, 4.810719e-05, 3.872474e-05, 3.383505e-05, 3.383505e-05, 9.102408e-06, 9.102408e-06, 1.040762e-05, 1.302218e-05, 2.085014e-05, 5.578405e-05, 0.0002180481 };
   ...
   Graph_Graph23->SetMinimum(8.192167e-06);
   Graph_Graph23->SetMaximum(0.0006772977);
   ...
   Double_t Graph0_fy4[6] = { 0.0003937073, 0.0001036713, 3.972656e-05, 2.494219e-05, 2.003625e-05, 1.74344e-05 };
   ...
   Double_t Graph_fy5[6] = { 0.133, 0.0161, 0.00144, 8.16e-05, 2.34e-06, 2.48e-08 };
   ...
   Double_t Graph_fy6[6] = { 0.1197, 0.01449, 0.001296, 7.344e-05, 2.106e-06, 2.232e-08 };
   ...
   Graph_Graph6->SetMinimum(2.0088e-08);
   Graph_Graph6->SetMaximum(0.13167);
   ...
   Double_t Graph_fy7[6] = { 0.1463, 0.01771, 0.001584, 8.976e-05, 2.574e-06, 2.728e-08 };
   ...
   Graph_Graph7->SetMinimum(2.4552e-08);
   Graph_Graph7->SetMaximum(0.16093);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.355652,0,9.355652,2.307308e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.350652,0,"  9.36 TeV");
