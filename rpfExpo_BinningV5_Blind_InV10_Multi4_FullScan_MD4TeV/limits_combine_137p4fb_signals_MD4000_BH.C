...
//=========  (Sun Nov 17 17:09:19 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(1.702853e-05);
   Graph_Graph12->SetMaximum(0.002370694);
   ...
   Graph_Graph23->SetMinimum(2.488609e-05);
   Graph_Graph23->SetMaximum(0.00172414);
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.385087,0,9.385087,5.945066e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.380087,0,"  9.39 TeV");
