...
//=========  (Sun Nov 17 16:55:08 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(6.659141e-05);
   Graph_Graph12->SetMaximum(0.004608739);
   ...
   Graph_Graph23->SetMinimum(4.197355e-05);
   Graph_Graph23->SetMaximum(0.003436833);
