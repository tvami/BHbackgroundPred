...
#endif
void limits_combine_137p6fb_signals_B3_n4_MD6000_BH()
{
//=========Macro generated from canvas: climits/climits
//=========  (Sun Mar  2 15:45:01 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[5] = { 9.248109e-05, 4.195459e-05, 2.791598e-05, 2.265632e-05, 1.987577e-05 };
   ...
   Double_t Graph1_fy2[12] = { 0.0002686102, 0.0001275764, 8.488819e-05, 6.889436e-05, 6.043915e-05, 6.043915e-05, 5.90062e-06, 5.90062e-06, 6.637593e-06, 8.178511e-06, 1.229138e-05, 2.745532e-05 };
   ...
   Graph_Graph12->SetMinimum(5.310558e-06);
   Graph_Graph12->SetMaximum(0.0002948811);
   ...
   Double_t Graph2_fy3[12] = { 0.0001698942, 8.07526e-05, 5.395417e-05, 4.396925e-05, 3.857303e-05, 3.857303e-05, 1.037704e-05, 1.037704e-05, 1.176859e-05, 1.450067e-05, 2.179288e-05, 4.828389e-05 };
   ...
   Graph_Graph23->SetMinimum(9.339332e-06);
   Graph_Graph23->SetMaximum(0.0001858459);
   ...
   Double_t Graph0_fy4[5] = { 9.248109e-05, 4.195459e-05, 2.791598e-05, 2.265632e-05, 1.987577e-05 };
   ...
   Double_t Graph_fy5[5] = { 0.00591879, 0.000361021, 1.03273e-05, 8.79857e-08, 1.658e-10 };
   ...
   Double_t Graph_fy6[5] = { 0.005326911, 0.0003249189, 9.29457e-06, 7.918713e-08, 1.4922e-10 };
   ...
   Graph_Graph6->SetMinimum(1.34298e-10);
   Graph_Graph6->SetMaximum(0.005859602);
   ...
   Double_t Graph_fy7[5] = { 0.006510669, 0.0003971231, 1.136003e-05, 9.678427e-08, 1.8238e-10 };
   ...
   Graph_Graph7->SetMinimum(1.64142e-10);
   Graph_Graph7->SetMaximum(0.007161736);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.683989,0,8.683989,3.175145e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.678989,0,"  8.68 TeV");
